...
class Arvernus:
    ...
    def process_update(self, moved_vehicle: Vehicle):
        ...
        self.av_veh[vId] = (asm.time + self.distance_to_time(app_dist, speed) + self.distance_to_time(tv_dist, speed), csm.destination_x, csm.destination_y)
...
class Announcer(BaseStrategy):
    ...
    def strategy_loop(self):
        while True:
            ...
            pending_updates = [VehicleUpdate(vId, cId) for tm, (vId, cId) in ap if tm >= current_time]
